...
export const TRANSACTION_CONSTRUCTION_CONTRACT_MOCKS_PHASE = 82 as const;
export const PHASE_82_TRANSACTION_CONSTRUCTION_CONTRACT_MOCKS_GENERATED_AT = '2026-05-14T00:00:00.000Z' as const;
export const PHASE_82_TRANSACTION_CONSTRUCTION_CONTRACT_MOCKS_SOURCE =
  'phase82_transaction_construction_contract_mocks_v1' as const;
export const PHASE_82_TRANSACTION_CONSTRUCTION_CONTRACT_MOCKS_VERSION = '1.0.0' as const;
export const PHASE_82_TRANSACTION_CONSTRUCTION_CONTRACT_MOCKS_SCHEMA_VERSION = '1.0.0' as const;

export const TRANSACTION_CONSTRUCTION_CONTRACT_MOCKS_NAMES = [
  'mock-construction-contract-ready',
  'missing-execution-boundary-blocked',
  'real-transaction-object-rejected',
  'serialization-request-denied',
  'signing-request-denied',
  'dispatch-request-denied',
  'unsafe-account-meta-rejected',
  'unsafe-capability-rejected',
] as const;

export const TRANSACTION_CONSTRUCTION_CONTRACT_MOCKS_KINDS = [
  'mock_construction_contract_ready',
  'missing_execution_boundary_blocked',
  'real_transaction_object_rejected',
  'serialization_request_denied',
  'signing_request_denied',
  'dispatch_request_denied',
  'unsafe_account_meta_rejected',
...
export type TransactionConstructionContractMockName = (typeof TRANSACTION_CONSTRUCTION_CONTRACT_MOCKS_NAMES)[number];
export type TransactionConstructionContractMockKind = (typeof TRANSACTION_CONSTRUCTION_CONTRACT_MOCKS_KINDS)[number];
...
export interface ExecutionBoundaryGate {
  ...
  readonly phase: typeof TRANSACTION_CONSTRUCTION_CONTRACT_MOCKS_PHASE;
...
export interface ExecutionBoundaryViewModel {
  ...
  readonly fixtureName: TransactionConstructionContractMockName;
  readonly gateStatus: ExecutionBoundaryGateStatus;
  readonly stateStatus: ExecutionBoundaryStateStatus;
  readonly approvalStatus: ExecutionApprovalStatus;
...
export interface ExecutionBoundarySelectorQuery {
  readonly fixtureId?: string;
  readonly fixtureName?: TransactionConstructionContractMockName;
  readonly fixtureKind?: TransactionConstructionContractMockKind;
}

export interface ExecutionBoundarySelector {
  readonly selectorId: string;
  readonly selectedFixtureId: string;
  readonly selectedFixtureKind: TransactionConstructionContractMockKind;
  readonly matched: boolean;
  readonly source: 'deterministic_fixture_only';
}

export interface TransactionConstructionContractMockCapabilities {
...
export interface TransactionConstructionContractMockFixture {
  readonly fixtureId: string;
  readonly fixtureName: TransactionConstructionContractMockName;
  readonly fixtureKind: TransactionConstructionContractMockKind;
  readonly phase: typeof TRANSACTION_CONSTRUCTION_CONTRACT_MOCKS_PHASE;
  readonly schemaVersion: typeof PHASE_82_TRANSACTION_CONSTRUCTION_CONTRACT_MOCKS_SCHEMA_VERSION;
  ...
  readonly capabilities: TransactionConstructionContractMockCapabilities;
  ...
  readonly meta: {
    readonly generatedAt: typeof PHASE_82_TRANSACTION_CONSTRUCTION_CONTRACT_MOCKS_GENERATED_AT;
    readonly source: typeof PHASE_82_TRANSACTION_CONSTRUCTION_CONTRACT_MOCKS_SOURCE;
    readonly version: typeof PHASE_82_TRANSACTION_CONSTRUCTION_CONTRACT_MOCKS_VERSION;
    readonly phase: typeof TRANSACTION_CONSTRUCTION_CONTRACT_MOCKS_PHASE;
...
export interface BuildTransactionConstructionContractMockFixtureInput {
  readonly fixtureName: TransactionConstructionContractMockName;
}

export interface TransactionConstructionContractMockValidationIssue {
...
export interface TransactionConstructionContractMockValidationResult {
  readonly valid: boolean;
  readonly issues: readonly TransactionConstructionContractMockValidationIssue[];
}

export interface TransactionConstructionContractMockSafetyResult {
