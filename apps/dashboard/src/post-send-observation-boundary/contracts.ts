import type { PostSendObservationBoundaryApiContract } from './types.js';

export function buildPostSendObservationBoundaryApiContract(input: {
  fixtureId: string;
  fixtureIds: readonly string[];
}): PostSendObservationBoundaryApiContract {
  return {
    list: {
