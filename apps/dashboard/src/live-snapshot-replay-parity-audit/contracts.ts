import type { LiveSnapshotReplayParityAuditApiContract } from './types.js';

export function buildLiveSnapshotReplayParityAuditApiContract(input: {
  fixtureId: string;
  fixtureIds: readonly string[];
}): LiveSnapshotReplayParityAuditApiContract {
  return {
    list: {
