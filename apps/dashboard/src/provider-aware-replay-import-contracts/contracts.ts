import type {
  ProviderAwareReplayImportContractApiContract,
    ...
    errors: [
      {
        ...
        contractKind: 'error',
        statusCode: 400,
        errorCode: 'PROVIDER_AWARE_REPLAY_IMPORT_CONTRACT_INVALID_REQUEST',
      ...
      },
      {
        ...
        contractKind: 'error',
        statusCode: 404,
        errorCode: 'PROVIDER_AWARE_REPLAY_IMPORT_CONTRACT_NOT_FOUND',
